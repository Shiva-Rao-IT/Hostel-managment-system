...
public class LeavedStudents extends javax.swing.JFrame {
    ...
    public LeavedStudents() {
        ...
        try
        {
            ...
            while(rs.next())
            {
            model.addRow(new Object[]{rs.getString(2),rs.getString(1),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7),rs.getString(8),rs.getString(9),rs.getString(10)});
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Roll No", "Name", "Mobile No", "Email id", "Father's Name", "Mother's Name", "Address", "College", "Aadhar No", "Room No"
            }
        ));
        jTable1.setMaximumSize(new java.awt.Dimension(2147483647, 500));
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, 710, 450));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagees/Untitled design.jpg"))); // NOI18N
